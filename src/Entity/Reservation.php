 ...
 * Reservation
 *
 * @ORM\Table(name="reservation", indexes={@ORM\Index(name="id_user", columns={"id_user"}), @ORM\Index(name="id_cours", columns={"id_cours"}), @ORM\Index(name="id_codepromo", columns={"id_codepromo"}), @ORM\Index(name="idf", columns={"idf"})})
...
class Reservation
{
     ...
     * @var Cours
     *
     * @ORM\ManyToOne(targetEntity="Cours", inversedBy="reservations")
     * @ORM\JoinColumn(name="id_cours", referencedColumnName="id")
     */
    private $courss;
    ...
    {
        // Set the default value of date_reservation to the current date and time
    ...
    public function setCategoriecodepromos(?categoriecodepromo $categoriecodepromos): self
    {
        $this->categoriecodepromos = $categoriecodepromos;
    ...
    public function setCourss(?cours $courss): self
    {
        $this->courss = $courss;
